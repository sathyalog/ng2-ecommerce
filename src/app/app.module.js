    ...
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, http_1.HttpModule,
            router_1.RouterModule.forRoot([
                { path: 'products', component: product_list_component_1.ProductListComponent, canActivate: [product_list_guard_1.ProductListGuard] },
                {
                    path: 'product/:id',
        ...
        providers: [product_guard_1.ProductDetailGuard, angular2_jwt_1.AUTH_PROVIDERS, product_list_guard_1.ProductListGuard],
