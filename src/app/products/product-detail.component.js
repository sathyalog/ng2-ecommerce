...
var ProductDetailComponent = (function () {
  ...
  ProductDetailComponent.prototype.getProduct = function (id) {
    var _this = this;
    this._productService.getProduct(id).subscribe(function (product) {
  ...
  ProductDetailComponent.prototype.getProductName = function (name) {
    var _this = this;
    this._productService.getProductName(name).subscribe(function (product) {
      return _this.product = product;
    }, function (error) {
      return _this.errorMessage = error;
    });
  ...
  ProductDetailComponent.prototype.addToCart = function (product) {
    var _this = this;
    this._cartService.addCart(product).subscribe(function (cart) {
      return _this.cart = product;
    }, function (error) {
      return _this.errorMessage = error;
    });
  };
...
ProductDetailComponent = __decorate([
  core_1.Component({
    templateUrl: '../../assets/static/template/product-detail.component.html',
